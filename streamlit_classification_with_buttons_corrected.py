...
if st.button('Distribution of Quantity and consumption', key='button_1'):
    import matplotlib.pyplot as plt
    import seaborn as sns
    df_eda = df
...
if st.button('Box plot of Quantity and Consumption', key='button_3'):
...
if st.button('Distribution of numerical columns', key='button_4'):
    import matplotlib.pyplot as plt
    import seaborn as sns
    df_eda = df
...
if st.button('Boxplots to visualize outliers', key='button_5'):
    ## Boxplots to visualize outliers
    plt.subplot(2, 3, 3)
...
if st.button('Histogram & KDE', key='button_6'):
    ## Histogram & KDE
...
if st.button('Consumption vs Consumption_level', key='button_7'):
    fig, axs = plt.subplots(1, 2, figsize=(15, 7))
    plt.subplot(121)
...
if st.button('Location Quantity consumption', key='button_8'):
...
if st.button('Multivariate analysis ', key='button_9'):
...
if st.button('Analysis on Location Column', key='button_10'):
...
if st.button('Location with aggrgated columns', key='button_11'):
    import numpy as np
    import matplotlib.pyplot as plt
...
if st.button('Dealer influence', key='button_12'):
    f,ax=plt.subplots(1,2,figsize=(20,10))
...
if st.button('Show Plot', key='button_13'):
...
if st.button('Prodcts infulence', key='button_14'):
...
if st.button('Different products', key='button_15'):
